...
#define COMMON SOUNDSDIR "/game-chess_"
...
sound_play(AppSoundData * app_sound_data, enum SoundType sound)
{
	...
	COMMON "successful_selection.wav",
     	COMMON "unsuccesful_selection.wav",
	COMMON "successful_movement.wav",
	COMMON "illegal_move.wav",
	COMMON "piece_capture.wav",
	COMMON "check.wav",
	COMMON "checkmate.wav",
     };
